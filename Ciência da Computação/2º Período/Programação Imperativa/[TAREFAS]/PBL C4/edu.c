//Eduardo Lago, Mateus Marcimiano, Lucas Azevedo
#include <stdio.h>
#include <string.h>
...
char mes_str[NUM_MESES][10] = { "janeiro", "fevereiro", "março", "abril", "maio", 
"junho", "julho",
...
int main()
{
    ...
    if (escolha < 0 || escolha > NUM_MESES - 1) {
        printf("Escolha inválida!");
        return 1;
    }

    printf("\nPintores nascidos no mês de %s:", mes_str[escolha]);
    int counter = 0;
    for (int i = 0; i < NUM_PINTORES; i++)
        if (pintor[i].mes == escolha) {
