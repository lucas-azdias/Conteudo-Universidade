...
data = []
url = "https://scholar.google.com/scholar?hl=pt-BR&as_sdt=0%2C5&as_ylo=2023&q=%22it+professionals%22+%22skills+gap%22+&btnG="
...
df.to_csv('dados_artigos.csv', index=False)
